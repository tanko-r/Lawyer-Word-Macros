in file: word/vbaProject.bin - OLE stream: 'VBA/FKSDONewVersion'
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
...
If verIncremental = True Then
    ...
    verBeforeDot = Left(sVer, InStr(1, sVer, ".", vbTextCompare) - 1)
    sNewName = Replace(sNewName, sVer, Format(verBeforeDot + 1, "00"))
Else
